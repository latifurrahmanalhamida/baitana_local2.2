...
//                               <SidebarMenuButton
//                                   tooltip={item.title}
//                                   className="text-white/90 hover:text-black hover:bg-white/15 data-[state=open]:bg-white/20 data-[state=open]:text-white transition-all duration-200 rounded-lg font-medium"
//                               >
//                                 {item.icon && (
//                                     <item.icon className="w-5 h-5 text-white/80 hover:text-black transition-colors duration-200" />
//                                 )}
//                                 <span className="flex-1 text-white hover:text-white">{item.title}</span>
//                                 <ChevronRight className="ml-auto w-4 h-4 transition-all duration-300 group-data-[state=open]/collapsible:rotate-90 text-white/60 hover:black/90" />
//                               </SidebarMenuButton>
//                             </CollapsibleTrigger>
...
//                                       <SidebarMenuSubButton
//                                           asChild
//                                           className="text-white/70 hover:text-white hover:bg-white/10 transition-all duration-200 rounded-md py-2 font-normal group relative before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-2 before:h-0.5 before:bg-white/40 before:rounded-full hover:before:bg-white/80 before:transition-colors before:duration-200"
//                                       >
...
//                               asChild
//                               tooltip={item.title}
//                               className="text-white/90 hover:text-white hover:bg-white/15 transition-all duration-200 rounded-lg font-medium group"
//                           >
//                             <a href={item.url} className="flex items-center gap-3 w-full py-2.5 px-3">
//                               {item.icon && (
//                                   <item.icon className="w-5 h-5 text-white/80 group-hover:text-white transition-colors duration-200" />
//                               )}
...
//         <div className="mx-4 my-4 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent"></div>
//
//         <SidebarGroup>
//           <SidebarMenu>
//             <SidebarMenuItem>
