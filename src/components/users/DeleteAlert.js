...
export default function DeleteAlert({
    ...
    const handleConfirmDelete = async () => {
        try {
            ...
            const messageToDisplay = error?.message || "Terjadi kesalahan saat menghapus user.";
        ...
        <>
            ...
            {errorDialogOpen && (
                <AlertDialog open={errorDialogOpen} onOpenChange={setErrorDialogOpen}>
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            <AlertDialogTitle className={"text-center text-red-500"}>Gagal Menghapus User!</AlertDialogTitle>
