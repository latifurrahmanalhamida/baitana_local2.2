...
export function RoleTable({
    ...
    const renderPagination = () => {
        ...
        return (
            <Pagination>
                <PaginationContent>
                    <li slot="pagination-item">
                        <button
                            key="first"
                            onClick={() => setCurrentPage(1)}
                            disabled={currentPage === 1}
                            className="flex items-center p-2.5 justify-start rounded-md text-sm cursor-pointer hover:bg-accent disabled:pointer-events-none disabled:opacity-50"
                            title="First Page"
                        >
                    ...
                    <li slot="pagination-item">
                        <button
                            ...
                            className="flex items-center p-2 justify-start rounded-md text-sm cursor-pointer hover:bg-accent disabled:pointer-events-none disabled:opacity-50"
                            title="Last Page"
                        >
        ...
        <Card>
            <CardContent>
                <div className="space-y-4">
                    ...
                    {/* Pagination Controls */}
                    <div className="px-1 pt-3 border-t border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
