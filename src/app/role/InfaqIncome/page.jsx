...
export default function TabelPemasukanInfaq() {
  const data = [
    { kode: "INFQ-001", jenis: "Infak Rutin", jumlah: 100000, note: "Dari jamaah tetap" },
    { kode: "INFQ-002", jenis: "Infak Jumat", jumlah: 200000, note: "Kotak infak" },
    { kode: "INFQ-003", jenis: "Infak Sosial", jumlah: 150000, note: "Untuk bantuan bencana" },
  ]
  ...
  return (
    <div className="p-6 bg-green-50 rounded-xl shadow-md">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
        <h2 className="text-xl font-semibold text-green-900">Pemasukan Infaq</h2>
      ...
      <Table className="bg-white border rounded-xl shadow-sm">
        <TableCaption className="text-sm text-muted-foreground">
          Daftar pemasukan infaq 
        </TableCaption>
        <TableHeader className="bg-green-100">
          <TableRow>
            <TableHead className="text-green-800 w-[180px]">Kode Transaksi</TableHead>
            <TableHead className="text-green-800">Jenis Infaq</TableHead>
