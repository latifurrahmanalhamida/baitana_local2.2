...
export function JenisInfaqDataTable({
  columns,
  data,
  isLoading = false,
  searchQuery,
  ...
  React.useEffect(() => {
    table.getColumn("nama_jenis_infaq")?.setFilterValue(searchQuery);
  }, [searchQuery, table]);
                ...
                {table
                  ...
                  .map((column) => {
                    return (
                      ...
                      >
                        {{
                          kode_jenis_infaq: "Kode Jenis Infaq",
                          nama_jenis_infaq: "Nama Jenis Infaq",
                  ...
                  >
                    <div className="flex flex-col items-center justify-center space-y-2">
                      <div className="text-muted-foreground">
                        Tidak ada data jenis infaq ditemukan
                      </div>
                      <div className="text-sm text-muted-foreground">
                        Coba ubah filter pencarian atau tambah jenis infaq baru
                      </div>
                    </div>
                  </TableCell>
                </TableRow>
