...
export const createColumns = (openEditModal, openDeleteAlert, openPreviewReceiptModal) => [
    ...
    {
        accessorKey: "expense_transaction",
        header: ({ column }) => {
            return (
                <Button
                    variant="ghost"
            ...
            return (
                <div className="flex items-center justify-center gap-2">
                    <Button
                        variant="outline"
                        size="sm"
                        onClick={() => openEditModal(financeExpense)}
                    ...
                    <Button
                        variant="outline"
                        size="sm"
                        onClick={() => openDeleteAlert(financeExpense)}
