    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, columnId, filterValue) => {
            ...
            return (
                ...
                String(row.original.capacity || '').toLowerCase().includes(search) ||
                String(row.original.price_per_hour || '').toLowerCase().includes(search) ||
                                ...
                                <TableRow>
                                    <TableCell colSpan={columns.length} className="h-32 text-center">
                                        <div className="flex flex-col items-center justify-center space-y-2">
                                            <div className="text-muted-foreground">Tidak ada data fasilitas ditemukan</div>
