...
export const createColumns = (openEditModal, openDeleteAlert) => [
    ...
    {
        accessorKey: "news_category_code",
        header: ({ column }) => {
            return (
                <Button
                    variant="ghost"
        ...
        cell: ({ row }) => {
            return (
                <Badge variant="outline" className="bg-blue-50 text-[#2C3E9E] border-[#2C3E9E]/30 font-medium px-3 py-1">
                    {row.getValue("news_category_code")}
                </Badge>
            )
        },
        size: 150,
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="space-y-1">
                    <div className="text-sm font-medium text-gray-900">{newsCategory.created_at}</div>
                    <div className="text-xs text-muted-foreground">{newsCategory.created_at_human}</div>
                </div>
            )
        },
        size: 180,
            ...
            return (
                <div className="flex items-center justify-center gap-2">
                    <Button
                        variant="outline"
                        size="sm"
                        onClick={() => openEditModal(newsCategory)}
                    ...
                    <Button
                        variant="outline"
                        size="sm"
                        onClick={() => openDeleteAlert(newsCategory)}
