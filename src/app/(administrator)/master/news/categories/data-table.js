...
export function DataTable({ columns, data, isLoading = false, onAddNew }) {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, columnId, filterValue) => { // filter
            ...
            return (
                row.original.news_category_code?.toLowerCase().includes(search) ||
                                ...
                                <TableRow>
                                    <TableCell colSpan={columns.length} className="h-32 text-center">
                                        <div className="flex flex-col items-center justify-center space-y-2">
                                            <div className="text-muted-foreground">Tidak ada data ketegori berita ditemukan</div>
                                            <div className="text-sm text-muted-foreground">
                                                Coba ubah filter pencarian atau tambah kategori berita baru
                                            </div>
                                        </div>
                                    </TableCell>
                                </TableRow>
